...
<section class="menu" >
  <ul class="menu__inner clearfix" >
    <li  class="menu__inner--img clearfix" >
      <router-link to="/order">
      <div>
        <img src="../../assets/images/myOrder_icon.png">
      </div>
        <span class="menu_text">我的订单</span>
      </router-link>
    </li>
    <li  class="menu__inner--img clearfix" >
      <a href="javascript:">
        <div>
          <img src="../../assets/images/pre-sale_icon.png">
        </div>
       <span class="menu_text">预售商品</span>
      </a>
    </li>
    <li  class="menu__inner--img clearfix" >
      <a href="javascript:">
      <div>
        ...
        <span class="menu_text">收货地址</span>
      </a>
    </li>
    <li  class="menu__inner--img clearfix" >
      <a href="javascript:">
      <div>
        <img src="../../assets/images/addDistraputionCenter_icon.png">
      </div>
        <span class="menu_text">添加配送中心</span>
      </a>
    </li>
  </ul>
  <mt-swipe :auto="0">
